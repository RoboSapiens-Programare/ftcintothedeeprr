...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.00053;
    public static double STRAFE_TICKS_TO_INCHES = 0.00053;
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(1, 6.5, 0);
        strafeEncoderPose = new Pose(-8.2, 1.18, Math.toRadians(90));
