...
public class ExampleBucketAuto extends OpMode {
    ...
    public void buildPaths() {
        ...
        pula = follower.pathBuilder()
                .addPath(new BezierLine(new Point(9.000, 111.000, Point.CARTESIAN), new Point(48.000, 111.000, Point.CARTESIAN)))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(315))
                .addPath(
                        new BezierLine(
                                new Point(48.000, 111.000, Point.CARTESIAN),
                                new Point(30.000, 54.000, Point.CARTESIAN)
                        )
                )
                ...
                .addPath(
                        ...
                        new BezierLine(
                                new Point(30.000, 54.000, Point.CARTESIAN),
                                new Point(111.000, 23.000, Point.CARTESIAN)
                        )
                )
