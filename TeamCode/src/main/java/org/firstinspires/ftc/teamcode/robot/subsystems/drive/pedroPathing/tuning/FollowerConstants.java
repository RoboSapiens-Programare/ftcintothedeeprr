...
import org.firstinspires.ftc.teamcode.robot.subsystems.drive.pedroPathing.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.robot.subsystems.drive.pedroPathing.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.robot.subsystems.drive.pedroPathing.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 64;
    ...
    public static double forwardZeroPowerAcceleration = -28.373801;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -62.966;
    ...
    public static double zeroPowerAccelerationMultiplier = 2.7;
    ...
    public static double translationalPIDFSwitch = 0;
